...
<template>
  <div class="flex  h-full">
    <div class="content-box  fr-container  flex  justify-center">
      <div>
        <DsfrLogo
          :logo-text="logoText"
        ...
        />
        <div>
          <h1 class="connection-title  fr-text--xl">
            Connectez-vous à {{ applicationName }}
          </h1>
          <p class="connection-description  fr-text--sm">
            Choisissez un mode de connexion
          </p>
          <ul class="connection-modes">
            <li class="connection-modes__mode">
              <SimpleCard
                target="passage2"
                :logo="passage2"
                text="Passage 2"
          ...
          <p class="connection-description  fr-text--sm">
            ...
            <a
              ...
              href=""
            >contactez le support</a> de {{ applicationName || '[application]' }}.
          </p>
        </div>
      </div>
    </div>
...
.connection-modes__mode {
  flex-basis: 34%;
  flex-grow: 1;
  flex-shrink: 1;
  margin: 0.5rem 0;
}
.connection-modes__mode:nth-child(odd) {
  margin-right: 0.5rem;
}
.connection-modes__mode:nth-child(even) {
  margin-left: 0.5rem;
}
